...
// 诗人路线颜色
const colorList = ['#FFE9A0','#367E18','#F57328','#CC3636','#FA7070','#FBF2CF','#C6EBC5','#A1C298','#6E85B7','#B2C8DF','#C4D7E0','#F8F9D7','#CDF0EA','#F9F9F9'];
...
const model_url = "http://101.34.228.44:3003/public/model.gltf";
export {
	CesiumToken,
	colorList,
	cesium_css_url,
